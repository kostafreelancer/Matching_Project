...
<div class="market">
            ...
            <!-- //market : e --> 
              <div class="btn_box">
            <input class="btn btn-lg btn-default js-disable-on-click" autocomplete="off" data-loading-text="저장 중" name="save_for_later" value="이전" type="submit">
            <input class="btn btn-lg btn-client js-disable-on-click btn-submit" autocomplete="off" data-loading-text="제출 중" name="post_a_job" value="마이페이지로" type="submit">
            <br><br><br><br><br>
           </div>

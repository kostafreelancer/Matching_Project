...
>>>>>>> 9cffe6be1feca6357727c1c4afa162d2250a0032:WebContent/c_join/f_join.jsp
								...
								<tbody>
									<tr>
										...
										<td colspan="3"><input type="text" id="fm_id"
											name="fm_id" /> <a href="javascript:IDCheckIt();"
											class="btn_overlap">중복확인</a> * 6~15자의 영문, 영문+숫자, 일부 특수문자( _ -
											)만 사용 가능합니다. <input type="hidden" name="f_id" id="idcheck">
										</td>
									</tr>
									<tr>
										<th scope="row" class="ac"><label for="fm_passwd1"><span
												class="txt_or">*</span> 비밀번호</label></th>
										<td><input type="password" id="fm_passwd1" name="f_pwd1"
											class="wid02" /></td>
										<th scope="row" class="ac"><label for="fm_passwd2"><span
												class="txt_or">*</span> 비밀번호 확인</label></th>
										<td><input type="password" id="fm_passwd2" name="f_pwd2"
											class="wid02" /></td>
									</tr>
								</tbody>
						</table>
					...
					<div class="tb_box">
						...
						<table class="tb_st01">
							...
							<tbody>
								<tr>
									<td rowspan="5"><img src="../images/bg/join_photo.jpg"
										alt="사진" /> <input type="file" name="fm_file1"
										onchange="PreView(this.value, 'IMG1', '132', '176');"
										style="width: 130px;" /> <!--<a href="#" class="photo_up">사진업로드</a>-->
										<span class="pho_txt">최적 해상도:132x176 pixel</span></td>
									<th scope="row"><label for="fm_name"><span
											class="txt_or">*</span> 성명</label></th>
									<td><input type="text" id="fm_name" name="f_name"
										class="wid04" value="" /></td>
								</tr>
								<tr>
									<th scope="row"><label for="fm_birth"><span
											class="txt_or">*</span> 생년월일</label></th>
									<td><input type="text" id="fm_birth" name="f_birth"
										class="wid04" maxlength="6" /> <select name="f_sex">
											<option value="1" selected>남자</option>
											<option value="2">여자</option>
									</select> <span class="mail_ma"> * 주민번호 앞 6자리를 입력해주세요.</span></td>
								</tr>
								<tr>
									<th scope="row"><label for="fm_phone1"><span
											class="txt_or">*</span> 연락처(휴대폰)</label></th>
									<td><select name="f_phone1">
											<option value="" selected>----</option>
											<option value="010">010</option>
											<option value="011">011</option>
											<option value="016">016</option>
										...
										type="text" id="fm_phone2" name="f_phone2" class="wid03"
										maxlength="4"> <span>-</span> <label for="fm_phone3"></label>
										<input type="text" id="fm_phone3" name="f_phone3"
										class="wid03" maxlength="4"></td>
								</tr>
								<tr>
									<th scope="row"><label for="fm_tel1">연락처(전화)</label></th>
									<td><label for="f_tel1"></label> <select class="wid03"
										name="fm_tel1">
											<option value="">----</option>
											<option value="02">02</option>
											<option value="031">031</option>
										...
										type="text" id="fm_tel2" name="f_tel2" class="wid03"
										maxlength="4"> <span>-</span> <label for="fm_tel3"></label>
										<input type="text" id="fm_tel3" name="f_tel3" class="wid03"
										maxlength="4"></td>
								</tr>
								<tr>
									<th><span class="txt_or">*</span> 이메일</th>
									<td><label for="fm_email11"></label> <input type="text"
										id="fm_email11" name="f_email" class="wid04"> <span>@</span>
										<label for="fm_email22"></label> <input type="text"
										id="fm_email12" name="f_email2" class="wid04"> <label
										for="fm_emailSel1"></label> <select class="wid04"
										name="f_emailSel1" id="fm_emailSel1"
									...
									<td colspan="2">
										...
										<div>
											<label for="fm_address"></label> <input type="text"
												id="fm_address" name="f_address" class="wid">
										</div>
									</td>
								</tr>
							</tbody>

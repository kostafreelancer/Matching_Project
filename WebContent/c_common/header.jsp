	...
	<div class="header">
		<div class="header_top_menu">
			...
			<ul class="header_top_menus">
				...
				<li><img alt="join_img"
					...
					<a href="/Matching_Project/join/join_step1.jsp">회원가입</a></li>
				<li><img alt="log_img"
					src="/Matching_Project/c_common/c_common_img/header_log_icon01.jpg">
					<a href="/Matching_Project/login/login.jsp">로그인</a></li>
				<li><img alt="home_img"
		...
		<div class="header_menu">
			<ul class="header_menus">
				...
				<li><a href="/Matching_Project/mypage_free_jsp/myInfo.jsp">마이페이지</a>
				</li>
				<li><a href="/Matching_Project/using_method/f_service.jsp">이용
						방법</a></li>
